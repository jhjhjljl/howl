...
Howl styles the content, not the layout. Howl provides 100% semantic coverage for every [MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements) tag. Howl does not touch broad containers like `<div>`, `<section>`, or `<main>` — layout is your business, the details are mine.
